...
const WelcomeSection = () => {
  return (
    <div className="WelcomeSection">
      <div className="bg_tint">
        <div className="content">
          <h1>Welcome!</h1>
          <p>
            We're glad you made it here and hope you're hungry for new flavors.
            Our pizza is made with passion and attention to details, starting
